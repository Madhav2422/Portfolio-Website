  ...
  return (
    <div className='flex flex-col gap-4 h-full justify-center md:text-left text-center max-w-2xl mx-auto px-4 py-16 text-white'>
      ...
      <div className='flex gap-4 mt-6 justify-center md:justify-start'>
        <button className='px-6 py-2 bg-[#0f172a] hover:bg-[#0a1224] text-white rounded-md font-medium transition-all'>
          View Work
        </button>
        <button className='px-6 py-2 border border-white text-white hover:bg-white hover:text-[#0f172a] rounded-md font-medium transition-all'>
          Contact Me
        </button>
      </div>
    </div>
